...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllConferences`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllEventBillSummaries`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllEventPhotoComments`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllEventPhotos`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllEvents`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllEventVideoComments`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllEventVideos`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllExpenses`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllLogActivities`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllMemberFees`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllMembers`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllOfficeMembers`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllOldExams`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllProjects`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllPublications`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllRoleAccessRights`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllRoles`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllTutorials`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllUserProfiles`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllUsers`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteAllVeterans`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteConference`(_conferenceId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteEvent`(_eventId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteEventBillSummary`(_billSummaryId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteEventPhoto`(_photoId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteEventPhotoComment`(_photoCommentId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteEventVideo`(_videoId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteEventVideoComment`(_videoCommentId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteExpense`(_expenseId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteIncome`(_incomeId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteLogActivity`(_activityId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteMember`(_memberId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteMemberFee`(_memberFeeId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteOfficeMember`(IN `_officeMemberId` INT(11))
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteOldExam`(_examId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteProject`(_projectId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deletePublication`(_publicationId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteRole`(_roleId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteRoleAccessRight`(_roleAccessId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteTutorial`(_tutorialId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteUser`(_userId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteUserProfile`(_profileId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `deleteVeteran`(_veteranId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewConference`(_date  datetime  
,_title  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewEvent`(_title  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewEventBillSummary`(_eventId  int(11)  
,_title  varchar(50)  
,_summary  text  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewEventPhoto`(_eventId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewEventPhotoComment`(IN `_photoId` INT(11), IN `_userId` INT(11), IN `_commentText` TEXT, IN `_date` DATETIME)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewEventVideo`(_eventId  int(11)  
,_fileFullName  varchar(512)  
,_title  varchar(50)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewEventVideoComment`(_videoId  int(11)  
,_userId  int(11)  
,_commentText  text  
,_date  datetime  
)
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewExpense`(_eventId  int(11)  
,_title  varchar(50)  
,_amount  double  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewIncome`(_eventId  int(11)  
,_title  varchar(50)  
,_amount  double  
,_category  enum('CultureWeek','FirstSemesterParty','GalaNight','Gaduation','GrillParty','Challenge','Mourning','Donation','Sport','Divers')  
,_billFileName  varchar(512)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewLogActivity`(_userId  int(11)  
,_summary  text  
,_date  datetime  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewMember`(_gender  enum('Male','Female')  
,_name  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewMemberFee`(_memberId  int(11)  
,_amount  double  
,_billFileName  varchar(512)  
,_transactionDate  datetime  
)
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewOfficeMember`(_memberId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewOldExam`(_userId  int(11)  
,_subject  varchar(50)  
,_title  varchar(120)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewProject`(_userId  int(11)  
,_title  varchar(50)  
,_summary  text  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewPublication`(_userId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewRole`(_name  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewRoleAccessRight`(_roleId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewTutorial`(_memberId  int(11)  
,_date  datetime  
,_subject  varchar(50)  
,_level  varchar(50)  
,_location  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewUser`(_loginName  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewUserProfile`(_userId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `insertNewVeteran`(_gender  enum('Male','Female')  
,_name  varchar(50)  
,_lastName  varchar(50)  
,_email  varchar(100)  
,_phoneNumber  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectActualFinancesStatus`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllConferences`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllEntitiesRecordsCount`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllEventBillSummaries`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllEventPhotoComments`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllEventPhotos`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllEvents`()
BEGIN
    SELECT khev_Event.*,
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllEventVideoComments`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllEventVideos`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllExpenses`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllExpensesByYear`()
BEGIN
    SELECT 
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllIncomes`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllIncomesByYear`()
BEGIN
    SELECT 
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllLogActivities`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllMemberFees`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllMembers`()
BEGIN
                SELECT khev_Member.*
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllOfficeMembers`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllOldExams`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllPhotosByEvent`(IN `_eventId` INT(11))
BEGIN
    SELECT khev_EventPhoto.*, khev_Event.title AS eventTitle
    FROM khev_EventPhoto 
    LEFT JOIN  khev_Event 
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllProjects`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllPublications`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllRoleAccessRights`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllRoles`()
BEGIN
                SELECT khev_Role.*
                FROM khev_Role    ;
            END$$
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllTutorials`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllUserProfiles`()
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllUsers`()
BEGIN
                SELECT khev_User.*
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectAllVeterans`()
BEGIN
                SELECT khev_Veteran.*
                FROM khev_Veteran    ;
            END$$
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectConferenceDetails`(_conferenceId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectEventBillSummaryDetails`(_billSummaryId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectEventDetails`(_eventId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectEventPhotoCommentDetails`(_photoCommentId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectEventPhotoDetails`(_photoId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectEventsByCategory`(IN `_category` 
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectEventVideoCommentDetails`(_videoCommentId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectEventVideoDetails`(_videoId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectExpenseDetails`(_expenseId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectIncomeDetails`(_incomeId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectLogActivityDetails`(_activityId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectMemberDetails`(_memberId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectMemberFeeDetails`(_memberFeeId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectOfficeMemberDetails`(_officeMemberId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectOldExamDetails`(_examId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectProjectDetails`(_projectId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectPublicationDetails`(_publicationId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectRoleAccessRightDetails`(_roleAccessId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectRoleDetails`(_roleId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectTutorialDetails`(_tutorialId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectUserDetails`(_userId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectUserProfileDetails`(_profileId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `selectVeteranDetails`(_veteranId  int(11)  
)
BEGIN
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateConference`(
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateConferenceDate`(
                _conferenceId  int(11)  
,_date  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateConferenceLocation`(
                _conferenceId  int(11)  
,_location  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateConferenceSummary`(
                _conferenceId  int(11)  
,_summary  text  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateConferenceTitle`(
                _conferenceId  int(11)  
,_title  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEvent`(
                            _eventId  int(11)  
,_title  varchar(50)  
,_category  enum('CultureWeek','FirstSemesterParty','GalaNight','Gaduation','GrillParty','Challenge','Mourning','Divers','Football','Tournament')  
,_date  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventBillSummary`(
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventBillSummaryEventId`(
                _billSummaryId  int(11)  
,_eventId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventBillSummarySummary`(
                _billSummaryId  int(11)  
,_summary  text  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventBillSummarySummaryFileName`(
                _billSummaryId  int(11)  
,_summaryFileName  varchar(512)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventBillSummaryTitle`(
                _billSummaryId  int(11)  
,_title  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventCategory`(
                _eventId  int(11)  
,_category  enum('CultureWeek','FirstSemesterParty','GalaNight','Gaduation','GrillParty','Challenge','Mourning','Divers','Football','Tournament')  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventDate`(
                _eventId  int(11)  
,_date  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventLocation`(
                _eventId  int(11)  
,_location  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventPhoto`(
                            _photoId  int(11)  
,_eventId  int(11)  
,_fileFullName  varchar(512)  
,_title  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventPhotoComment`(
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventPhotoCommentCommentText`(
                _photoCommentId  int(11)  
,_commentText  text  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventPhotoCommentDate`(
                _photoCommentId  int(11)  
,_date  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventPhotoCommentPhotoId`(
                _photoCommentId  int(11)  
,_photoId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventPhotoCommentUserId`(
                _photoCommentId  int(11)  
,_userId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventPhotoEventId`(
                _photoId  int(11)  
,_eventId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventPhotoFileFullName`(
                _photoId  int(11)  
,_fileFullName  varchar(512)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventPhotoTitle`(
                _photoId  int(11)  
,_title  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventSummary`(
                _eventId  int(11)  
,_summary  text  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventTitle`(
                _eventId  int(11)  
,_title  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventVideo`(
                            _videoId  int(11)  
,_eventId  int(11)  
,_fileFullName  varchar(512)  
,_title  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventVideoComment`(
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventVideoCommentCommentText`(
                _videoCommentId  int(11)  
,_commentText  text  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventVideoCommentDate`(
                _videoCommentId  int(11)  
,_date  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventVideoCommentUserId`(
                _videoCommentId  int(11)  
,_userId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventVideoCommentVideoId`(
                _videoCommentId  int(11)  
,_videoId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventVideoEventId`(
                _videoId  int(11)  
,_eventId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventVideoFileFullName`(
                _videoId  int(11)  
,_fileFullName  varchar(512)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateEventVideoTitle`(
                _videoId  int(11)  
,_title  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateExpense`(
                            _expenseId  int(11)  
,_eventId  int(11)  
,_title  varchar(50)  
,_amount  double  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateExpenseAmount`(
                _expenseId  int(11)  
,_amount  double  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateExpenseBillFileName`(
                _expenseId  int(11)  
,_billFileName  varchar(512)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateExpenseCategory`(
                _expenseId  int(11)  
,_category  enum('CultureWeek','FirstSemesterParty','GalaNight','Gaduation','GrillParty','Challenge','Mourning','Donation','Sport','Divers')  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateExpenseEventId`(
                _expenseId  int(11)  
,_eventId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateExpenseTitle`(
                _expenseId  int(11)  
,_title  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateExpenseTransactionDate`(
                _expenseId  int(11)  
,_transactionDate  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateIncome`(
                            _incomeId  int(11)  
,_eventId  int(11)  
,_title  varchar(50)  
,_amount  double  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateIncomeAmount`(
                _incomeId  int(11)  
,_amount  double  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateIncomeBillFileName`(
                _incomeId  int(11)  
,_billFileName  varchar(512)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateIncomeCategory`(
                _incomeId  int(11)  
,_category  enum('CultureWeek','FirstSemesterParty','GalaNight','Gaduation','GrillParty','Challenge','Mourning','Donation','Sport','Divers')  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateIncomeDate`(
                _incomeId  int(11)  
,_date  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateIncomeEventId`(
                _incomeId  int(11)  
,_eventId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateIncomeTitle`(
                _incomeId  int(11)  
,_title  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateIncomeTransactionDate`(
                _incomeId  int(11)  
,_transactionDate  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateLogActivity`(
                            _activityId  int(11)  
,_userId  int(11)  
,_summary  text  
,_date  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateLogActivityDate`(
                _activityId  int(11)  
,_date  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateLogActivitySummary`(
                _activityId  int(11)  
,_summary  text  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateLogActivityUserId`(
                _activityId  int(11)  
,_userId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMember`(
                            _memberId  int(11)  
,_gender  enum('Male','Female')  
,_name  varchar(50)  
,_lastName  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberAddress`(
                _memberId  int(11)  
,_address  varchar(256)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberCity`(
                _memberId  int(11)  
,_city  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberEmail`(
                _memberId  int(11)  
,_email  varchar(100)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberFee`(
                            _memberFeeId  int(11)  
,_memberId  int(11)  
,_amount  double  
,_billFileName  varchar(512)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberFeeAmount`(
                _memberFeeId  int(11)  
,_amount  double  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberFeeBillFileName`(
                _memberFeeId  int(11)  
,_billFileName  varchar(512)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberFeeMemberId`(
                _memberFeeId  int(11)  
,_memberId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberFeeTransactionDate`(
                _memberFeeId  int(11)  
,_transactionDate  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberGender`(
                _memberId  int(11)  
,_gender  enum('Male','Female')  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberLastName`(
                _memberId  int(11)  
,_lastName  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberName`(
                _memberId  int(11)  
,_name  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberPhoneNumber`(
                _memberId  int(11)  
,_phoneNumber  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberPosition`(
                _memberId  int(11)  
,_position  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateMemberZipCode`(
                _memberId  int(11)  
,_zipCode  varchar(10)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateOfficeMember`(
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateOfficeMemberMemberId`(
                _officeMemberId  int(11)  
,_memberId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateOfficeMemberPosition`(
                _officeMemberId  int(11)  
,_position  enum('President','Secretary','ChiefCulture','ChiefSport','Treasurer')  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateOldExam`(
                            _examId  int(11)  
,_userId  int(11)  
,_subject  varchar(50)  
,_title  varchar(120)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateOldExamDate`(
                _examId  int(11)  
,_date  datetime  
...
DROP PROCEDURE IF EXISTS `updateOldExamFileFullName`$$
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateOldExamFileFullName`(
                _examId  int(11)  
,_fileFullName  varchar(512)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateOldExamSemester`(
                _examId  int(11)  
,_semester  varchar(10)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateOldExamSubject`(
                _examId  int(11)  
,_subject  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateOldExamTitle`(
                _examId  int(11)  
,_title  varchar(120)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateOldExamUserId`(
                _examId  int(11)  
,_userId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateProject`(
                            _projectId  int(11)  
,_userId  int(11)  
,_title  varchar(50)  
,_summary  text  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateProjectSummary`(
                _projectId  int(11)  
,_summary  text  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateProjectTitle`(
                _projectId  int(11)  
,_title  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateProjectUserId`(
                _projectId  int(11)  
,_userId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updatePublication`(
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updatePublicationCategory`(
                _publicationId  int(11)  
,_category  enum('Info','Concert','Hiwi','Mourning')  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updatePublicationDate`(
                _publicationId  int(11)  
,_date  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updatePublicationSummary`(
                _publicationId  int(11)  
,_summary  text  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updatePublicationUserId`(
                _publicationId  int(11)  
,_userId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateRole`(
                            _roleId  int(11)  
,_name  varchar(50)  
,_description  varchar(120)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateRoleAccessRight`(
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateRoleAccessRightCreateRight`(
                _roleAccessId  int(11)  
,_createRight  bit(1)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateRoleAccessRightDeleteRight`(
                _roleAccessId  int(11)  
,_deleteRight  bit(1)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateRoleAccessRightEditRight`(
                _roleAccessId  int(11)  
,_editRight  bit(1)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateRoleAccessRightEntityType`(
                _roleAccessId  int(11)  
,_entityType  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateRoleAccessRightFullRight`(
                _roleAccessId  int(11)  
,_fullRight  bit(1)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateRoleAccessRightReadRight`(
                _roleAccessId  int(11)  
,_readRight  bit(1)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateRoleAccessRightRoleId`(
                _roleAccessId  int(11)  
,_roleId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateRoleDescription`(
                _roleId  int(11)  
,_description  varchar(120)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateRoleName`(
                _roleId  int(11)  
,_name  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateTutorial`(
                            _tutorialId  int(11)  
,_memberId  int(11)  
,_date  datetime  
,_subject  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateTutorialDate`(
                _tutorialId  int(11)  
,_date  datetime  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateTutorialLevel`(
                _tutorialId  int(11)  
,_level  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateTutorialLocation`(
                _tutorialId  int(11)  
,_location  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateTutorialMemberId`(
                _tutorialId  int(11)  
,_memberId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateTutorialShedules`(
                _tutorialId  int(11)  
,_shedules  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateTutorialStatus`(
                _tutorialId  int(11)  
,_status  enum('Cancelled','Active')  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateTutorialSubject`(
                _tutorialId  int(11)  
,_subject  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUser`(
                            _userId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserEmail`(
                _userId  int(11)  
,_email  varchar(100)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserHashPassword`(
                _userId  int(11)  
,_hashPassword  varchar(20)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserLastName`(
                _userId  int(11)  
,_lastName  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserLoginName`(
                _userId  int(11)  
,_loginName  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserName`(
                _userId  int(11)  
,_name  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserPhoneNumber`(
                _userId  int(11)  
,_phoneNumber  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserProfile`(
                            _profileId  int(11)  
,_userId  int(11)  
,_gender  enum('Male','Female')  
,_photoFileName  varchar(256)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserProfileAddress`(
                _profileId  int(11)  
,_address  varchar(256)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserProfileCity`(
                _profileId  int(11)  
,_city  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserProfileDefalutLanguage`(
                _profileId  int(11)  
,_defalutLanguage  enum('DE','FR','EN')  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserProfileGender`(
                _profileId  int(11)  
,_gender  enum('Male','Female')  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserProfilePhotoFileName`(
                _profileId  int(11)  
,_photoFileName  varchar(256)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserProfileStreet`(
                _profileId  int(11)  
,_street  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserProfileUserId`(
                _profileId  int(11)  
,_userId  int(11)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateUserProfileZipCode`(
                _profileId  int(11)  
,_zipCode  varchar(10)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateVeteran`(
                            _veteranId  int(11)  
,_gender  enum('Male','Female')  
,_name  varchar(50)  
,_lastName  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateVeteranAddress`(
                _veteranId  int(11)  
,_address  varchar(256)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateVeteranCity`(
                _veteranId  int(11)  
,_city  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateVeteranEmail`(
                _veteranId  int(11)  
,_email  varchar(100)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateVeteranGender`(
                _veteranId  int(11)  
,_gender  enum('Male','Female')  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateVeteranLastName`(
                _veteranId  int(11)  
,_lastName  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateVeteranName`(
                _veteranId  int(11)  
,_name  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateVeteranPhoneNumber`(
                _veteranId  int(11)  
,_phoneNumber  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateVeteranPosition`(
                _veteranId  int(11)  
,_position  varchar(50)  
...
CREATE DEFINER=`ccq9128cw_khev`@`%` PROCEDURE `updateVeteranZipCode`(
                _veteranId  int(11)  
,_zipCode  varchar(10)  
