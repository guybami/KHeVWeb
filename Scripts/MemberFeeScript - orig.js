 ...
 var transactionDateColWidth = "auto";  
            ...
            var xhrArgs = {
                ...
                error: function (errorMsg) {
                    ...
                    logError({ message: "Failed to get all memberfees from server: \n" + errorMsg });
                }
            };
            var oldCellValue = "";
            ...
            function fetchDataCompleted(data) {
                ...
                if (memberfeesStore != null) {
                    ...
                    memberfeesStore.comparatorMap = {};memberfeesStore.comparatorMap["memberId"] = compareStringIgnoreCase; memberfeesStore.comparatorMap["amount"] = compareStringIgnoreCase; memberfeesStore.comparatorMap["billFileName"] = compareStringIgnoreCase; memberfeesStore.comparatorMap["transactionDate"] = compareStringIgnoreCase;  
        ...
        function displayMemberFeeView(userAction) {
            ...
            var postParameters = { "memberfeeId": memberfeeId, "userAction": userAction };
            var xhrArgs = {
                url: controllerUrl,
                postData: postParameters,
                ...
                method: postMethod,
                error: function (errorMsg) {
                    logError({ message: "Reponse failed to get memberfee details with error: " + errorMsg });
                }
            };
