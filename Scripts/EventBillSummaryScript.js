                ...
                * Script to manage a  EventBillSummary model entity.
                * @author
                *     Guy Bami W.
                * Created changes: 08.04.2017 20:48:15
                */
        ...
        // global varaibles
        var eventbillsummariesStore = null;
        var eventbillsummariesGrid = null;
        var currentItemIndex = -1;
        var itemsArrayIds = new Array();
        var currentEventBillSummaryId = -1;


        // some eventbillsummary actions commands
        var viewAllItemsCmd = "viewAllEventBillSummaries";
        ...
        var dataItemsGridId = "eventbillsummariesGrid";
        var itemDetailsDivId = "eventbillsummaryDetailsDiv";
        var itemsGridDivId = "eventbillsummariesGridDiv";
        var itemDetailsFormId = "eventbillsummaryDetailsForm";
        var eventbillsummaryDetailsFormId = "eventbillsummaryDetailsForm";
        ...
        var eventbillsummaryDetailsDialogId = "eventbillsummaryDetailsDialog";
        ...
        var controllerUrl = "../../Controllers/EventBillSummaryController.php";
        ...
        var subMenuItemSectionTitleLabel = "EventBillSummaries";
                    ...
                    try {
                        ...
                        var parsePageWidgets = function () {
                            ...
                            if (customUserRolesManagerObject != null && customUserRolesManagerObject.userRolesData.length > 0) {
                                ...
                                curmo.entityType = curmo.entityTypesObject.EventBillSummary;
                                readItemRight = curmo.getAccessRightByEntityType(curmo.entityTypesObject.EventBillSummary, curmo.accessRightsObject.readRight);
                            }
                            if (readItemRight == true) {
                                ...
                                generateEventBillSummariesDataGrid(itemsGridDivId);
                            }
                            else {
...
function setLabelFields(jsonData){
 ...
 $("#summaryFileNameLabel").html(jsonData[0].summaryFileName);
...
setFormFieldValue("summaryFileName", jsonData[0].summaryFileName);
...
setFormFieldValue("eventId", "41966");
setFormFieldValue("title", "title-6521307");
setFormFieldValue("summary", "summary-fe27f92");
setFormFieldValue("summaryFileName", "summaryFileName-1751a9a");

}

       /**
        * generate dynamic EventBillSummaries datagrid
        * @param {string} targetDiv
        * @returns {none}
        */
        function generateEventBillSummariesDataGrid(targetDiv) {
   
            var windowWidth = $(window).width() - 200;
 var eventIdColWidth = windowWidth * 0.25 + "px"; 
 var titleColWidth = windowWidth * 0.25 + "px"; 
 var summaryColWidth = windowWidth * 0.25 + "px"; 
 var summaryFileNameColWidth = "auto";  
            ...
            if (customUserRolesManagerObject != null && customUserRolesManagerObject.userRolesData.length > 0) {
                var curmo = customUserRolesManagerObject; // short name
                curmo.entityType = curmo.entityTypesObject.EventBillSummary;
                dataEditable = curmo.getAccessRightByEntityType(curmo.entityTypesObject.EventBillSummary, curmo.accessRightsObject.editRight);
            }

             var columsLayout = [
                 
                    {
                        name: pageLangTexts.eventIdColLabel == null ? "EventId" : pageLangTexts.eventIdColLabel,
                        field: "eventId",
                        dataType: "number",
                    ...
                    ,{
                        name: pageLangTexts.summaryFileNameColLabel == null ? "SummaryFileName" : pageLangTexts.summaryFileNameColLabel,
                        field: "summaryFileName",
                        dataType: "string",
                        editable: dataEditable,
                        type: dojox.grid.cells._Widget,
                        width: summaryFileNameColWidth,
                        widgetClass: dijit.form.TextBox,
                        widgetProps: {}
                    } 
                 ]; 
            ...
            var xhrArgs = {
                ...
                error: function (errorMsg) {
                    ...
                    displayErrorContent("errorContentDiv", "Failed to get all eventbillsummaries from server: " + errorMsg);
                    logError({ message: "Failed to get all eventbillsummaries from server: \n" + errorMsg });
                }
            };
            var oldCellValue = "";
            ...
            function fetchDataCompleted(data) {
                ...
                eventbillsummariesStore = new dojo.data.ItemFileWriteStore({
                    data: {
                        identifier: "eventbillsummaryId",
                        items: jsonData
                    }
                });

                if (eventbillsummariesStore != null) {
                    // save data store
                    eventbillsummariesStore.save({
                    ...
                    eventbillsummariesStore.comparatorMap = {};eventbillsummariesStore.comparatorMap["eventId"] = compareStringIgnoreCase; eventbillsummariesStore.comparatorMap["title"] = compareStringIgnoreCase; eventbillsummariesStore.comparatorMap["summary"] = compareStringIgnoreCase; eventbillsummariesStore.comparatorMap["summaryFileName"] = compareStringIgnoreCase;  
                    ...
                    // create datagrid
                    eventbillsummariesGrid = new dojox.grid.EnhancedGrid({
                        id: dataItemsGridId,
                        store: eventbillsummariesStore,
                        ...
                        plugins: {
                            ...
                            filter: {
                                ...
                                itemsName: "EventBillSummaries"
                            }
                        }
                    });

                    // set sort index col
                    setSortColumnsIndexes(eventbillsummariesGrid, 2, true);
                    // add events trigger
                    eventbillsummariesGrid.on("SelectionChanged", reportSelection);
                    eventbillsummariesGrid.on("StartEdit", gridStartEdit);
                    eventbillsummariesGrid.on("ApplyCellEdit", gridApplyCellEdit);
                    eventbillsummariesGrid.placeAt(targetDiv);
                    // parse datagrid
                    eventbillsummariesGrid.startup();
                }
                ...
                function gridApplyCellEdit(inValue, inRowIndex, inFieldIndex) {
                    if (oldCellValue != null && inValue != oldCellValue) {
                        ...
                        obj["entityKeyId"] = storeItem["eventbillsummaryId"].toString();
                        var itemId = storeItem["eventbillsummaryId"].toString();
        ...
        function displayEventBillSummaryView(userAction) {

            var eventbillsummaryId = currentEventBillSummaryId;
            debugMessageToConsole("eventbillsummaryId:" + eventbillsummaryId, highLevel);
            debugMessageToConsole("userAction: " + userAction, highLevel);

            var windowHeight = $(window).height();
            var windowWidth = $(window).width();

            var postParameters = { "eventbillsummaryId": eventbillsummaryId, "userAction": userAction };
            var xhrArgs = {
                url: controllerUrl,
                postData: postParameters,
                ...
                method: postMethod,
                error: function (errorMsg) {
                    logError({ message: "Reponse failed to get eventbillsummary details with error: " + errorMsg });
                }
            };
            ...
            function fetchDataCompleted(data) {
                ...
                if (jsonData == null) {
                    displayErrorContent(errorContentDivId, "displayEventBillSummaryView: " + jsonErrorMsg);
                    return;
                }
                else if (jsonData.length == 1 && jsonData[0].jsonErrorMessage != null) {
                    displayErrorContent(errorContentDivId, jsonData[0].jsonErrorMessage);
        ...
        function viewEventBillSummaryDetails(eventbillsummaryId) {
            currentEventBillSummaryId = eventbillsummaryId;
            currentItemIndex = getCurrentItemIndex(eventbillsummaryId);
            displayEventBillSummaryView(viewItemDetailsCmd);
        }
        ...
        function createToolbarBtns(userAction) {
            ...
            if (customUserRolesManagerObject != null && customUserRolesManagerObject.userRolesData.length > 0) {
                ...
                if (!customUserRolesManagerObject.rolesLoaded) {
                    // load roles only once
                    curmo.entityType = curmo.entityTypesObject.EventBillSummary;
                    addNewItemRight = curmo.getAccessRightByEntityType(curmo.entityTypesObject.EventBillSummary, curmo.accessRightsObject.createRight);
                    editItemRight = curmo.getAccessRightByEntityType(curmo.entityTypesObject.EventBillSummary, curmo.accessRightsObject.editRight);
                    deleteItemRight = curmo.getAccessRightByEntityType(curmo.entityTypesObject.EventBillSummary, curmo.accessRightsObject.deleteRight);
        ...
        */
        function deleteItemsBtnClick() {
            ...
            if (eventbillsummariesGrid != null) {
                var items = eventbillsummariesGrid.selection.getSelected();
                if (items.length > 0) {
        ...
        */
            ...
            if (eventbillsummariesGrid != null) {
                ...
                if (items.length > 0) {
                    ...
                    for (var i = 0; i < items.length; i++) {
                        itemId = eventbillsummariesGrid.store.getValue(items[i], "eventbillsummaryId");
                        itemId = $.trim(itemId);
                    ...
                    // now delete items
                    deleteSeletedEventBillSummaries(selectedIdsArray);
                }
            }
        ...
        function registerButtonClickEvents() {
            ...
            $("#" + addNewItemBtnDialogId).click(function () {
                validateBeforeAddNewEventBillSummary();
            });
            $("#" + editItemBtnDialogId).click(function () {
                displayEventBillSummaryView(editItemDetailsCmd);
            });
            ...
            $("#" + saveChangesBtnDialogId).click(function () {
                saveEventBillSummaryChanges();
            });
            $("#" + cancelChangesBtnDialogId).click(function () {
                displayEventBillSummaryView(cancelChangesCmd);
            });
        ...
        function initFormValidators() {
            ...
            $("#" + eventbillsummaryDetailsFormId).validate({
                rules: {
        ...
        function validateBeforeAddNewEventBillSummary() {

            var isFormInputsValid = $("#" + eventbillsummaryDetailsFormId).valid();
            if (isFormInputsValid) {
                // close dialog
                closeAddEditItemDialog();
                // add callback
                addNewEventBillSummary();
            }
        }
        ...
        function showAddItemDialog() {
            ...
            if ($("#" + eventbillsummaryDetailsDialogId) != null) {
                // set content dialog
                ...
                $("#" + eventbillsummaryDetailsDialogId).modal("show");
            }
        }
        ...
        function closeAddEditItemDialog() {
            if ($("#" + eventbillsummaryDetailsDialogId) != null) {
                $("#" + eventbillsummaryDetailsDialogId).modal("hide");
            }
        }
        ...
        function addNewEventBillSummary() {

            var eventbillsummaryDetailsFormObject = $("#" + eventbillsummaryDetailsFormId).serializeObject();
            // convert form to json object
            var itemToAdd = eventbillsummaryDetailsFormObject;
            itemToAdd = eventbillsummaryDetailsFormObject;
            var postParameters = {
                "formValues[]": dojo.toJson(eventbillsummaryDetailsFormObject, true)
            ...
            //get postback result
            function addNewEventBillSummaryCompleted(data) {

                debugMessageToConsole("addNewEventBillSummaryCompleted data : " + data, highLevel);
                // get json result
                var jsonData = data;
                // clear error message
                $("#" + errorContentDivId).html("");
                if (jsonData == null) {
                    displayErrorContent(errorContentDivId, "addNewEventBillSummaryCompleted: " + jsonErrorMsg);
                    return;
                }
                else if (jsonData.length == 1 && jsonData[0].jsonErrorMessage != null) {
                    displayErrorContent(errorContentDivId, jsonData[0].jsonErrorMessage);
                ...
                if (eventbillsummariesStore != null && jsonData[0].insertedItemKey != null) {
                    itemToAdd.eventbillsummaryId = jsonData[0].insertedItemKey;
                    // redisplay data grid    
                    eventbillsummariesStore.newItem(itemToAdd);
                }
            }

            // send async xhr request to server
            sendAsyncRequest(xhrArgs.url, xhrArgs.postData, xhrArgs.handleAs, xhrArgs.method,
                xhrArgs.error, addNewEventBillSummaryCompleted);

        }


        function submitInlineGridChanges(eventbillsummaryId, jsonValues) {

            var postParameters = {
                "eventbillsummaryId": eventbillsummaryId,
        ...
        function deleteSeletedEventBillSummaries(eventbillsummaryIdsList) {
            var postParameters = {
                "selectedIds[]": eventbillsummaryIdsList,
            ...
            // send async xhr request to server
            sendAsyncRequest(xhrArgs.url, xhrArgs.postData, xhrArgs.handleAs, xhrArgs.method,
                xhrArgs.error, deleteSeletedEventBillSummariesCompleted);
            //get postback result
            function deleteSeletedEventBillSummariesCompleted(data) {

                var jsonData = data;
                $("#" + errorContentDivId).html("");
                if (jsonData == null) {
                    displayErrorContent("errorContentDiv", "deleteSeletedEventBillSummariesCompleted: " + jsonErrorMsg);
                    return;
                }
                else if (jsonData.length == 1 && jsonData[0].jsonErrorMessage != null) {
                    displayErrorContent(errorContentDivId, jsonData[0].jsonErrorMessage);
                ...
                var itemsToDelete = eventbillsummariesGrid.selection.getSelected();
                $.each(itemsToDelete, function (index, item) {
                    if (item) {
                        eventbillsummariesStore.deleteItem(item);
                    }
                });
                // save datastore
                eventbillsummariesStore.save();
        ...
        function submitEventBillSummaryDetailsForm(eventbillsummaryId) {
            //check form validation
            //if (!eventbillsummaryDetailsForm.validate()) {
            //    return;
            //}
            // convert form to json object
            var eventbillsummaryDetailsFormObject = $("#" + eventbillsummaryDetailsFormId).serializeObject();
            ...
            var jsonValues = dojo.toJson(eventbillsummaryDetailsFormObject);
            ...
            // send async xhr request to server
            sendAsyncRequest(xhrArgs.url, xhrArgs.postData, xhrArgs.handleAs, xhrArgs.method,
                xhrArgs.error, submitEventBillSummaryDetailsCompleted);
            //get postback result
            function submitEventBillSummaryDetailsCompleted(data) {
                //debugMessageToConsole(" EventBillSummaryDetailsForm-postback: " + $.trim(data), highLevel);
                var jsonData = data;
                $("#" + errorContentDivId).html("");
                if (jsonData == null) {
                    displayErrorContent(errorContentDivId, "submitEventBillSummaryDetailsCompleted: " + jsonErrorMsg);
                    return;
                }
                else if (jsonData.length == 1 && jsonData[0].jsonErrorMessage != null) {
                    displayErrorContent(errorContentDivId, jsonData[0].jsonErrorMessage);
                ...
                // get item to update
                var itemToUpdate = eventbillsummariesGrid.getItem(currentItemIndex); 

                

eventbillsummariesStore.setValue(itemToUpdate, "eventId", eventbillsummaryDetailsFormObject.eventId);
eventbillsummariesStore.setValue(itemToUpdate, "title", eventbillsummaryDetailsFormObject.title);
eventbillsummariesStore.setValue(itemToUpdate, "summary", eventbillsummaryDetailsFormObject.summary);
eventbillsummariesStore.setValue(itemToUpdate, "summaryFileName", eventbillsummaryDetailsFormObject.summaryFileName);
        ...
        function viewNextItemDetails() {
            ...
            var eventbillsummaryId = itemsArrayIds[currentItemIndex];
            viewEventBillSummaryDetails(eventbillsummaryId);
        }
        ...
        function saveEventBillSummaryChanges() {
            submitEventBillSummaryDetailsForm(currentEventBillSummaryId);
            if ($("#" + viewItemDetailsDialogId) != null) {
                $("#" + viewItemDetailsDialogId).modal("hide");
            }
        }
