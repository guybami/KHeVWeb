                ...
                * Insert an  LogActivity model entity.
                * @author  
                *    Guy Bami 
                */
 ...
 $content = ' <div class="_hideContent" id="viewItemDetailsFormContentDiv">
            ...
            <div class="form-group ">
                <label for="userIdLabel" class="control-label col-md-4">'.LogActivityUIResource::userIdColLabelText().'</label>
                <div class="col-md-8">
            ...
            <div class="form-group ">
                <label for="summaryLabel" class="control-label col-md-4">'.LogActivityUIResource::summaryColLabelText().'</label>
                <div class="col-md-8">
            ...
            <div class="form-group ">
                <label for="dateLabel" class="control-label col-md-4">'.LogActivityUIResource::dateColLabelText().'</label>
                <div class="col-md-8">
