...
<?php
    ...
    $title = 'Kameruner Heilbronn e.V - Expenses';
    // load UI resource 
   ...
   $script = '
        ...
        var pageLangTexts = {
          ...
          // combobox
          cultureWeekLabel : "'.ExpenseUIResource::cultureWeekLabelText().'",
            firstSemesterPartyLabel : "'.ExpenseUIResource::firstSemesterPartyLabelText().'",
            galaNightLabel : "'.ExpenseUIResource::galaNightLabelText().'",
            gaduationLabel : "'.ExpenseUIResource::gaduationLabelText().'",
            grillPartyLabel : "'.ExpenseUIResource::grillPartyLabelText().'",
            challengeLabel : "'.ExpenseUIResource::challengeLabelText().'",
            mourningLabel : "'.ExpenseUIResource::mourningLabelText().'",
            donationLabel : "'.ExpenseUIResource::donationLabelText().'",
            sportLabel : "'.ExpenseUIResource::sportLabelText().'",
            diversLabel : "'.ExpenseUIResource::diversLabelText().'",
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <div id="editItemDetailsFormContentDiv" class="hideContent">
                                    <div class="container">
                                        <form id="expenseDetailsForm" class="form-horizontal" name="expenseDetailsForm" encType="multipart/form-data">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <select   id="category" name="category" class="selectpicker1 show-tick1 form-control">
                                                        <option value="CultureWeek">'.ExpenseUIResource::cultureWeekLabelText().'</option>
                                                        <option value="FirstSemesterParty">'.ExpenseUIResource::firstSemesterPartyLabelText().'</option>
                                                        <option value="GalaNight">'.ExpenseUIResource::galaNightLabelText().'</option>
                                                        <option value="Gaduation">'.ExpenseUIResource::gaduationLabelText().'</option>
                                                        <option value="GrillParty">'.ExpenseUIResource::grillPartyLabelText().'</option>
                                                        <option value="Challenge">'.ExpenseUIResource::challengeLabelText().'</option>
                                                        <option value="Mourning">'.ExpenseUIResource::mourningLabelText().'</option>
                                                        <option value="Donation">'.ExpenseUIResource::donationLabelText().'</option>
                                                        <option value="Sport">'.ExpenseUIResource::sportLabelText().'</option>
                                                        <option value="Divers">'.ExpenseUIResource::diversLabelText().'</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8" nowrap="nowrap">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="hideContent">
                                                            ...
                                                            <input type="hidden"  name="userAction" id="userAction" value="uploadExpenseBill"/>
                                                        </div> 
                                                    </div>
                                                </div>
                                            </div>
