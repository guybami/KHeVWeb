...
<?php
    ...
    $title = 'Kameruner Heilbronn e.V - Events';
    // load UI resource 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <select  id="category" name="category" class="form-control">
                                                        <option value="CultureWeek">'.EventUIResource::cultureWeekLabelText().'</option>
                                                        ...
                                                        <option value="Gaduation">'.EventUIResource::gaduationLabelText().'</option>
                                                        <option value="GrillParty">'.EventUIResource::grillPartyLabelText().'</option>
