<?php
    ...
    $title = 'Kameruner Heilbronn e.V - Anciens Examens';
    // load UI resource 
   ...
   $script = '
        ...
        <script defer src="../../Scripts/oldExamsListScript.js"  type="text/javascript"> </script> 
                                                        ...
                                                        <tr>
                                                            <td class="toLeft">
                                                                <div id="toolbarButtonsDiv" class="hideContent">
                                                                    ...
                                                                    <span id="spanDeleteItemsBtn" class="hideContent" style="display:none;">
