...
<?php
    ...
    $title = 'Kameruner Heilbronn e.V - User Accounts';
    // load UI resource 
                                    ...
                                    <div class="container">
                                        <div class="form-horizontal" id="viewForm">   
                                            <div class="form-group">
                                                <label for="dateLabel" class="control-label col-md-4 ">Date</label>
                                                <div class="col-md-8">
                                                    <label class="form-control-static dataViewLabel" id="dateLabel"></label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="titleLabel" class="control-label col-md-4">Title</label>
                                                <div class="col-md-8">
                                                    <label class="form-control-static dataViewLabel" id="titleLabel"></label>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <label for="locationLabel" class="control-label col-md-4">Location</label>
                                                <div class="col-md-8">
                                                    <label class="form-control-static dataViewLabel" id="locationLabel"></label>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <label for="summaryLabel" class="control-label col-md-4">Summary</label>
                                                <div class="col-md-8">
                                ...
                                <div   id="editItemDetailsFormContentDiv" class="hideContent">
                                    <div class="container">
                                        <form id="conferenceDetailsForm" class="form-horizontal" data-dojo-id="conferenceDetailsForm" encType="multipart/form-data">
                                            <div class="form-group">
                                                <label for="inputTime" class="control-label col-md-4 noWrap">Date</label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <label for="title" class="control-label col-md-4 noWrap">Title</label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="title" name="title">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="location" class="control-label col-md-4 noWrap">Location</label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="location" name="location">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="summary" class="control-label col-md-4 noWrap">Summary</label>
                                                <div class="col-md-8">
