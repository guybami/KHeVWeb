...
<?php
    ...
    * The LogActivity cotntroller entity class.
    * @author
    *    Guy Bami W.
    */
    ...
    class LogActivityController extends BaseController
    {
        ...
        public function getAllLogActivities()
        {
            ...
            if (is_string($resultObject)) {
                ...
                for ($i = 0; $i < count($resultObject); $i++) {
                    $entitiesList .= '{"activityId":"' . $resultObject[$i]["activityId"] . '"' . ',"userId":"' . $resultObject[$i]["userId"] . '"' . ',"summary":"' . $resultObject[$i]["summary"] . '"' . ',"date":"' . $resultObject[$i]["date"] . '"' . '}';
        ...
        public function insertNewLogActivity($jsonData)
        {
            ...
            $resultObject = $this->logActivity->insertNewLogActivity($formJsonValues['userId'], $formJsonValues['summary'], $formJsonValues['date']);
        ...
        public function updateLogActivity($activityId, $updateMode, $jsonData)
        {
            ...
            if ($updateMode == "allFields") {
                ...
                $resultObject = $this->logActivity->updateLogActivityDetails($activityId, $formJsonValues['userId'], $formJsonValues['summary'], $formJsonValues['date']);
        ...
        public function getDynamicPageContent()
        {
            ...
            switch ($this->getUserAction()) {
                ...
                case "addNewItem":
                    //insert new entity
                    $resultObject = array('0' => array(userId => '', summary => '', date => ''));
                    $postbackData = Utils::convertArrayToJson($resultObject[0]);
                    break;
                case "viewDetails":
                case "cancelChanges":
