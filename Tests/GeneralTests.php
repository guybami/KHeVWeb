<?php
    ...
    function testConfirmMail() {
        // sendConfirmRegistrationMail($receiverMail, $pageLink)
        ...
        $pageLink = $rootURL . "Controllers/MemberRegistrationController.php?userAction=confirmRegistrationFromEmail&registrationId=2&code=ZJ72y4vOOgzFY7LaoCtFYwQLIqbt8lmOdTAbLl9tocKGrkGcKF";
        Utils::sendConfirmRegistrationMail('guybami@yahoo.fr', $pageLink);
    }
